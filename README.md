...
The DBF-xBase-FoxPro JDBC driver is provided by [DbSchema](https://dbschema.com/documentation/dbf/)
...
The driver can be tested by downloading and installing [DbSchema](https://dbschema.com). 
